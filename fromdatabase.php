...
include './clickheat/classes/Heatmap.class.php';
include './clickheat/classes/HeatmapFromDatabase.class.php';
include './smt/config.php';
...
$heatmap->query = 'SELECT coords_x, coords_y FROM smt2_records';
$heatmap->maxQuery = 'SELECT MAX(coords_y) FROM smt2_records';
...
$images = $heatmap->generate(1051, 867);
